...
the aim of ssh.py is to provide a platform to run cisco ios commands on SSH, for usage in projects such as network discovery, where failure and re-trying is expected.
